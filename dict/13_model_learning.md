...
**영문**: Pre-training · **분류**: [모델 학습·적응](README.md#분류content-class) · **최초 등장**: 2018-06
...
**상위 개념(이를 활용해 만든 개념)**: [파인튜닝 (FT)](#fine-tuning) · [LLM (대규모 언어 모델)](01_llm_basics.md#llm)

**관련 용어**: [파인튜닝 (FT)](#fine-tuning) · [LLM (대규모 언어 모델)](01_llm_basics.md#llm)
...
**영문**: Fine-Tuning · **분류**: [모델 학습·적응](README.md#분류content-class) · **최초 등장**: 2018-06
...
**하위 개념(더 일반·근본)**: [사전학습](#pretraining)

**상위 개념(이를 활용해 만든 개념)**: [지식 증류](#distillation) · [지시 튜닝](#instruction-tuning) · [PEFT (파라미터 효율 파인튜닝)](#peft) · [RLHF (인간 피드백 강화학습)](#rlhf)
...
**영문**: Instruction Tuning · **분류**: [모델 학습·적응](README.md#분류content-class) · **최초 등장**: 2021-09
...
**하위 개념(더 일반·근본)**: [파인튜닝 (FT)](#fine-tuning)
...
**영문**: RLHF · **분류**: [모델 학습·적응](README.md#분류content-class) · **최초 등장**: 2017-06
...
**영문**: Parameter-Efficient Fine-Tuning · **분류**: [모델 학습·적응](README.md#분류content-class) · **최초 등장**: 2019-02
...
**영문**: Low-Rank Adaptation · **분류**: [모델 학습·적응](README.md#분류content-class) · **최초 등장**: 2021-06
...
**하위 개념(더 일반·근본)**: [PEFT (파라미터 효율 파인튜닝)](#peft)
...
**영문**: Knowledge Distillation · **분류**: [모델 학습·적응](README.md#분류content-class) · **최초 등장**: 2015-03
...
**영문**: Quantization · **분류**: [모델 학습·적응](README.md#분류content-class) · **최초 등장**: 2015
...
**하위 개념(더 일반·근본)**: [추론 (서빙)](01_llm_basics.md#inference)
...
**영문**: Open-Weights Model · **분류**: [모델 학습·적응](README.md#분류content-class) · **최초 등장**: 2019-02
...
**영문**: Benchmark · **분류**: [모델 학습·적응](README.md#분류content-class) · **최초 등장**: 2018(GLUE)
...
**이 용어를 참조하는 항목**: [배치 러너](12_subsystems.md#batch-runner) · [트래젝토리 (실행 궤적)](12_subsystems.md#trajectory)
