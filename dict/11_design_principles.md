...
**영문**: Narrow Waist · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)
...
**상위 개념(더 특수)**: [풋프린트 사다리](#footprint-ladder)
...
**영문**: Footprint Ladder · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)
...
**하위 개념(더 일반)**: [좁은 허리 원칙](#narrow-waist)
...
**영문**: config.yaml · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)
...
**영문**: Behavior Contract Tests · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)
...
**상위 개념(더 특수)**: [변경 감지 테스트 (안티패턴)](#change-detector)
...
**영문**: Change-Detector Tests · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)

모델 목록·설정 버전 같은 현재 값을 그대로 박아 두어, 정당한 변경에도 깨지는 테스트 안티패턴. Hermes에서 명시적으로 금지됩니다.

**하위 개념(더 일반)**: [행위 계약 테스트](#behavior-contract)
...
**영문**: E2E Validation · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)
...
**영문**: Escape Hatch · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)
...
**영문**: Conventional Commits · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)
...
**영문**: Nous Portal · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)
...
**하위 개념(더 일반)**: [LLM 제공자](02_agent_core.md#provider)
...
**영문**: Managed Tools · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)
...
**하위 개념(더 일반)**: [도구](03_tool_system.md#tool)
...
**영문**: Turn Isolation · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)
...
**관련 용어**: [실행 환경](09_execution_infra.md#execution-environment) · [서버리스 컴퓨트](09_execution_infra.md#serverless)
...
**영문**: Skin · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)
...
**하위 개념(더 일반)**: [HermesCLI](07_gateway_interfaces.md#hermes-cli)
...
**영문**: Setup Wizard · **분류**: [설계 원칙·프로젝트 용어](README.md#분류content-class)
