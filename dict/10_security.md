...
**영문**: Command Approval · **분류**: [보안](README.md#분류content-class)
...
**하위 개념(더 일반)**: [터미널 도구](03_tool_system.md#terminal-tool)

**상위 개념(더 특수)**: [하드라인 차단 목록](#hardline-blocklist) · [YOLO 모드](#yolo-mode)
...
**영문**: Hardline Blocklist · **분류**: [보안](README.md#분류content-class)
...
**영문**: Untrusted Content · **분류**: [보안](README.md#분류content-class)
...
**상위 개념(더 특수)**: [프롬프트 인젝션](#prompt-injection) · [새니타이즈](#sanitization)
...
**영문**: Prompt Injection · **분류**: [보안](README.md#분류content-class)
...
**하위 개념(더 일반)**: [비신뢰 콘텐츠 원칙](#untrusted-content)

**상위 개념(더 특수)**: [도구 중독](#tool-poisoning)
...
**영문**: Tool Poisoning · **분류**: [보안](README.md#분류content-class)
...
**하위 개념(더 일반)**: [프롬프트 인젝션](#prompt-injection)
...
**영문**: Secrets in .env · **분류**: [보안](README.md#분류content-class)
...
**영문**: Sanitization · **분류**: [보안](README.md#분류content-class)
