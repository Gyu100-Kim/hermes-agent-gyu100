...
**영문**: Context Engineering · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)
...
**상위 개념(더 특수)**: [컨텍스트 압축](#context-compression) · [컨텍스트 엔진](#context-engine) · [점진적 공개](05_memory_self_improvement.md#progressive-disclosure)
...
**영문**: System Prompt Tiers · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)
...
**하위 개념(더 일반)**: [시스템 프롬프트](01_llm_basics.md#system-prompt)

**상위 개념(더 특수)**: [컨텍스트 파일 (AGENTS.md)](#context-file) · [SOUL.md](#soul-md)
...
**영문**: SOUL.md · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)
...
**하위 개념(더 일반)**: [시스템 프롬프트 3계층](#system-prompt-tiers)

**상위 개념(더 특수)**: [페르소나](#persona)
...
**영문**: Persona · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)

에이전트가 일관되게 유지하는 성격·말투·가치관. [SOUL.md](#soul-md)로 정의되며 프로필별로 다르게 설정할 수 있습니다.

**하위 개념(더 일반)**: [SOUL.md](#soul-md)
...
**영문**: Context Compression · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)
...
**하위 개념(더 일반)**: [컨텍스트 엔지니어링](#context-engineering)

**상위 개념(더 특수)**: [압축 쿨다운](#compression-cooldown) · [압축 계보](#compression-lineage) · [머리/꼬리 보호](#head-tail-protection) · [요약 기반 압축](#summarization)
...
**영문**: Summarization · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)

오래된 대화 구간을 LLM으로 요약해 짧은 텍스트로 대체하는 압축 방식. 정보 손실과 토큰 회수 사이의 균형이 핵심입니다.

**하위 개념(더 일반)**: [컨텍스트 압축](#context-compression)

**상위 개념(더 특수)**: [구조화 요약](#structured-summary) · [도구 출력 가지치기](#tool-output-pruning)
...
**영문**: Structured Summary · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)
...
**하위 개념(더 일반)**: [요약 기반 압축](#summarization)
...
**영문**: Head/Tail Protection · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)
...
**상위 개념(더 특수)**: [토큰 예산 기반 꼬리 보호](#token-budget-tail)
...
**영문**: Token-Budget Tail Protection · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)

'최근 N개 메시지'가 아니라 '꼬리에 남길 토큰 예산'으로 보호 범위를 정하는 방식. 메시지 길이 편차에 강건합니다.

**하위 개념(더 일반)**: [머리/꼬리 보호](#head-tail-protection)
...
**영문**: Tool Output Pruning · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)
...
**영문**: Lost in the Middle · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)
...
**하위 개념(더 일반)**: [컨텍스트 윈도우](01_llm_basics.md#context-window)
...
**영문**: Compression Lineage (parent_session_id) · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)
...
**영문**: Context Engine · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)
...
**영문**: Context Files · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)
...
**영문**: Compression Cooldown · **분류**: [프롬프트·컨텍스트](README.md#분류content-class)
