...
이 문서는 **상태·영속성·검색** 범주의 용어 19개를 다룹니다. 설명 속 파란 링크를 누르면 해당 용어 항목으로 이동하며, 각 항목 끝의 "이 용어를 참조하는 항목"으로 되돌아올 수 있습니다.
...
**영문**: Write-Ahead Logging · **범주**: 상태·영속성·검색
...
**영문**: FTS5 · **범주**: 상태·영속성·검색

[SQLite](#sqlite) 내장 전문 검색 확장(5세대). Hermes의 [세션 검색](#session-search)이 이것으로 구현되어, 별도 검색 서버 없이 과거 대화를 검색합니다.

**상위 개념**: [전문 검색 (FTS)](#fts) · [SQLite](#sqlite)

**하위 개념**: [BM25](#bm25) · [외부 콘텐츠 테이블](#external-content) · [세션 검색](#session-search) · [토크나이저 (검색)](#tokenizer)
...
**영문**: Inverted Index · **범주**: 상태·영속성·검색
...
**하위 개념**: [트라이그램 토크나이저](#trigram) · [unicode61 토크나이저](#unicode61)
...
**영문**: Session Search · **범주**: 상태·영속성·검색
